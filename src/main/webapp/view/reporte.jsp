                        ...
                        <div class="card-body bg-dark">
                            <table class="table table-success">
                                <tr class="black-text">
                                    <th>
                                        <%
                                            String EquipoSelect=request.getParameter("selectEquipo");
                                            if (EquipoSelect==null){EquipoSelect="";}else{EquipoSelect=request.getParameter("selectEquipo");}
                                        %>
                                        TIPO DE BIEN: <%= EquipoSelect%>
                                    </th>
                                </tr>
                            </table>
                            <div class="row">
